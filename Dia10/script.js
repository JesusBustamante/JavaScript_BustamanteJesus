...
function readid(url) {
    ...
    document.getElementById(`output`).innerHTML += `
        <div id="name">${daticos.data.tvShows}</div> 
        ...
        <div id="division">
            ...
            <div class="card-group">
                ...
                <div class="card">
                    <div id="imgPers">
                        <img src="${daticos.data.imageUrl}" class="card-img-top" alt="..." id="editIMg">
                    </div>

                    <div class="card-body">
                        <div class="card-title">Name: ${daticos.data.name}</div>
                    </div>

                    <div class="card-footer" style="background-color: black:">
                        <small class="text-body-secondary">${daticos.data.createdAt}</small>
                    </div>
            ...
            <div id="datosExtras">
                <div class="card text-bg-light mb-3" style="width: 25vw; margin-left: 25vw; height: auto;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">${daticos.data.shortFilms}</p>
                    </div>
                </div>
                <div class="card text-bg-light mb-3" style="width: 25vw; margin-left: 16vw; height: auto;">
                    ...
                    <div class="card-body" style="width: 25vw; height: auto;">
                        ...
                        <p class="card-text">${daticos.data.videoGames}</p>
                    </div>
                </div>
